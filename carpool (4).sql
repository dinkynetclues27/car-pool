...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 28, 2024 at 06:18 AM
...
(2, 1, 'Thar', 'ABC', '2', 'GJ01UV9090', 'satellite', 'bopal', 0.00, 'on', '2024-05-24', '12:00'),
(3, 4, 'Thar', 'ABC', '2', 'GJ01UV9090', 'ahmedabad', 'bopal', 0.00, 'on', '2024-05-22', '10:00'),
(6, 5, 'XUV', 'abj ', '4', 'GJ01TY1234', 'satellite', 'bopal', 100.00, 'on', '2024-05-23', '10:00');
...
(7, 'pass2@gmail.com', '$2b$10$4qedv4teC3FG7SvLl7x50OKoWeoiKR0KvyiYCevJyoKjE40fyRxsq', 'passenger');
...
(7, 'dinu', NULL, 'aaass', '7894561230', 16, 'approved');
...
CREATE TABLE IF NOT EXISTS `request` (
  ...
  `car_id` int NOT NULL,
  `user_id` int NOT NULL,
  `request_accept` enum('approved','rejected','pending') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
...
INSERT INTO `request` (`request_id`, `car_id`, `user_id`, `request_accept`) VALUES
(13, 1, 5, 'rejected'),
(16, 4, 5, 'rejected'),
(20, 5, 5, 'approved'),
(21, 1, 7, 'rejected'),
