...
//       const userId = localStorage.getItem('user_id');
//       try {
//         const response = await axios.get(`http://localhost:4000/getrequest`,{userId});
//         const requestedCars = response.data;
//         setSearchResults((prevResults) =>
//           prevResults.map((car) => ({
//             ...car,
//             requestStatus: (requestedCars.find((request) => request.car_id === car.car_id) || {}).request_accept || 'pending'
//           }))
//         );
//       } catch (error) {
...
//                     Request
//                   </button>
//                 ) : car.requestStatus === 'approved' ? (
//                   <p className="text-success">Request Approved</p>
//                 ) : (
